...
source.exclude_dirs = bin, __pycache__, OtherStuff, PassLOCK_old, data, screenshots, screenshot_original
...
requirements = python3,kivy==2.0.0,pillow,pycryptodome
...
android.presplash_color = #fdf8f6
